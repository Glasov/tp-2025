...
# ============================
# 4. Конкретные продукты для Linux
# ============================
...
if __name__ == "__main__":
    ...
    # Определяем текущую ОС (в реальности определяем автоматически)
    # Для примера будем создавать интерфейсы для разных ОС
    ...
    # Создаём приложения для каждой ОС
    ...
    config = "Windows"  # Это может приходить из настроек
